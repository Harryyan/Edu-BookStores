...
namespace WebAPI_01.Model
{
    public partial class BookStoresDbContext : DbContext
    {
        ...
        // Connect to db
        protected override void OnConfiguring(DbContextOptionsBuilder optionisBuilder)
        {
            if (!optionisBuilder.IsConfigured)
            {
                optionisBuilder.UseSqlServer("Data Source=.\\sqlexpress;Initial Catalog=BookStoreDB;Integrated Security=True");
                //optionisBuilder.UseSqlServer("Name=BookStoreDB");
            }
        }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            buildAuthorModel(modelBuilder);
            buildBookModel(modelBuilder);
            buildBookAuthorModel(modelBuilder);
            buildJobModel(modelBuilder);
            buildPublisherModel(modelBuilder);
            buildRefreshTokenModel(modelBuilder);
            buildRoleModel(modelBuilder);
            buildSaleModel(modelBuilder);
            buildStoreModel(modelBuilder);
            buildUserModel(modelBuilder);

            OnModelCreatingPartial(modelBuilder);
        }

        private void buildAuthorModel(ModelBuilder modelBuilder)
        {
        ...
        private void buildBookModel(ModelBuilder modelBuilder)
        {
        ...
        private void buildBookAuthorModel(ModelBuilder modelBuilder)
        {
        ...
        private void buildJobModel(ModelBuilder modelBuilder)
        {
        ...
        private void buildPublisherModel(ModelBuilder modelBuilder)
        {
        ...
        private void buildRefreshTokenModel(ModelBuilder modelBuilder)
        {
        ...
        private void buildRoleModel(ModelBuilder modelBuilder)
        {
        ...
        private void buildSaleModel(ModelBuilder modelBuilder)
        {
        ...
        private void buildStoreModel(ModelBuilder modelBuilder)
        {
